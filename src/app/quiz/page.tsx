...
import { ArrowLeft, Book, TestTube, Paintbrush, Calculator, Lightbulb, Globe, Settings, Hash, BookOpen } from 'lucide-react';

const quizQuestions = [
  {
    id: 'q1',
    icon: Globe,
    question: "Question: 'Ocean' is to 'Water' as 'Desert' is to...?",
